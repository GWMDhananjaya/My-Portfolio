...
const SingleProject = ({ name, year, align, image, link, pname }) => {
  return (
    <motion.div
      ...
      class={`flex w-full sm:flex-col-reverse items-center gap-8 ${
    ...
    >
      ...
      <div className="max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transition-all duration-500 relative border border-white ">
        <div className="w-full h-full bg-cyan opacity-50 absolute top-0 left-0 hover:opacity-0 transition-all duration500 md:block sm:hidden ">
